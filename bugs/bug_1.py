# Keras==1.0.6
#pip3 install 'keras==1.0.6' --force-reinstall
import sys
import comet_ml
experiment = comet_ml.Experiment(api_key="LiaxyPemFgS6CCPazfCpjzFHF", log_code=True)
...
raw = open('dataset/wikigold.conll.txt', 'r').readlines()
all_x = []
point = []
for line in raw:
